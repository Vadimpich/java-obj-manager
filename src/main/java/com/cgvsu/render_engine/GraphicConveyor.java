...
public class GraphicConveyor {
    ...
    public static Vector3f vertexToSurface(final Vector3f vertex, final int width, final int height) {
        return new Vector3f((float) (vertex.x * width + width / 2.0), (float) (-vertex.y * height + height / 2.0), vertex.z);
    }
